#ifndef PAGE_OIL_TEMP_H
#define PAGE_OIL_TEMP_H
...
void drawPageOilTemp() {
  u8g2.clearBuffer();
  u8g2.setFont(u8g2_font_6x10_tr);
  
  // Title
  u8g2.drawStr(10, 15, "Oil Temp Page");
  
  // Content
  u8g2.setFont(u8g2_font_4x6_tr);
  u8g2.drawStr(10, 30, "Oil temperature");
  u8g2.drawStr(10, 40, "monitoring display.");
...
void handlePageOilTemp() {
  ...
  if (!just_entered_page && (current_time - last_button_time > DEBOUNCE_DELAY)) {
    if (digitalRead(5) == LOW && !button_select_pressed) { // BUTTON_SELECT
      ...
      Serial.println("Returning to menu from Oil Temp page");
    }
